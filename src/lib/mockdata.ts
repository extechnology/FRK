...
export const productData: ProductProps[] = [
    {
        id: 1,
        title: "SOLAR STREETLIGHT 600W-S1",
        ...
        specifications: {
            ...
            batteryDetails: [
                ...
                { label: "Battery Charging Time", value: "05Hrs – 06Hrs ( Normal Sunlight )" },
                { label: "Rainy Days Backup", value: "2 Days" },
                { label: "Battery Capacity", value: "60000mlAh (Ensures Autonomy In Cloudy Days)" },
    ...
    {
        id: 2,
        title: "SOLAR STREETLIGHT 600W-S2",
        subtitle: "Light control + Remote control",
        shortDescription: "Energy-efficient solar street lights with durable LiFePO₄ batteries, advanced tech, and easy installation for reliable, sustainable public lighting.",
        description: "Experience Powerful & Sustainable Outdoor Illumination with the 600W Solar Street Light.Designed for Performance and Efficiency, Equipped with a high-capacity LiFePO₄ battery and advanced Solar Panel Technology, it ensures Long -lasting Brightness quick charging & Reliable Operation even in low Sunlight Conditions.",
        images: [
            "/Solar-Street-Lights-S-600W-1-product.webp",
            "/Solar-Street-Lights-S-600W-2-product.webp",
            "/Solar-Street-Lights-S-600W-3-product.webp",
            "/Solar-Street-Lights-S-600W-4-product.jpg",
        ],
        specifications: {
            panelDetails: [
                { label: "Solar Panel Size", value: "610 × 580 mm" },
    ...
    },
    {
        ...
        specifications: {
            ...
            batteryDetails: [
                ...
                { label: "Battery Charging Time", value: "05Hrs – 06Hrs ( Normal Sunlight )" },
                { label: "Rainy Days Backup", value: "2 Days" },
                { label: "Battery Capacity", value: "80000mlAh (Ensures Autonomy In Cloudy Days)" },
                { label: "Ingress Protection", value: "IP66 or above (better than IP65)" },
            ],
    ...
    },
    {
        ...
        specifications: {
            ...
            batteryDetails: [
                ...
                { label: "Battery Charging Time", value: "05Hrs – 06Hrs ( Normal Sunlight )" },
                { label: "Rainy Days Backup", value: "2 Days" },
                { label: "Battery Capacity", value: "100000mlAh (Ensures Autonomy In Cloudy Days)" },
                { label: "Ingress Protection", value: "IP66 or above (better than IP65)" },
            ],
    ...
    {
        id: 5,
        title: "SOLAR HIGH MAST 1200W",
        subtitle: "Light control + Remote control",
        shortDescription: "FRK Solar 1200W High Mast Light delivers powerful, eco-friendly illumination with advanced solar technology and durable design. Built for reliability and efficiency, it ensures maximum brightness, long battery life, and superior performance in all weather conditions—perfect for highways, stadiums, industrial zones, and public spaces requiring consistent, high-intensity lighting.",
        description: "FRK Solar 1200W High Mast Light delivers powerful, eco-friendly illumination with advanced solar technology and durable design. Built for reliability and efficiency, it ensures maximum brightness, long battery life, and superior performance in all weather conditions—perfect for highways, stadiums, industrial zones, and public spaces requiring consistent, high-intensity lighting.",
        images: [
        ...
        specifications: {
            ...
            batteryDetails: [
                ...
                { label: "Battery Charging Time", value: "05Hrs – 06Hrs ( Normal Sunlight )" },
                { label: "Rainy Days Backup", value: "2 Days" },
                { label: "Battery Capacity", value: "120000mlAh (Ensures Autonomy In Cloudy Days)" },
                { label: "Charging Time", value: "5–6 Hours" },
                { label: "Ingress Protection", value: "IP66 or above (better than IP65)" },
            ],
