            ...
            >
                ...
                <div className="space-y-6 text-gray-800">
                    ...
                    <p>
                        ...
                        Policy. This Privacy Policy has been created with the help of the Free Privacy Policy Generator.
                    </p>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li><strong>Company</strong> refers to FRK Lighting Solution, Kottumuchi, Kodakkad Malappuram, Kerala, 673635.</li>
                    ...
                    <h3 className="text-xl font-semibold mt-4">We use both Session and Persistent Cookies for the purposes below:</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-6">We may share Your personal information in the following situations:</h3>
                    ...
                    <h3 className="text-xl font-semibold mt-4">Other Legal Requirements</h3>
                    <ul className="list-disc pl-5 space-y-2">
                        <li>Comply with a legal obligation</li>
                        <li>Protect and defend the rights of the Company</li>
                        <li>Prevent possible wrongdoing</li>
                    ...
                    <h2 className="text-2xl font-semibold mt-8">Detailed Information on Processing</h2>

                    <p>The Service Providers We use may have access to Your Personal Data. These third-party vendors collect, store, use, process and transfer information about Your activity on Our Service in accordance with their Privacy Policies.</p>

                    <h3 className="text-xl font-semibold mt-4">Mouseflow</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold mt-4">FreshDesk</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold mt-4">Google Places</h3>
                    <p>
